    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->dockWidget->hide();
    ui->dockWidget_2->setMinimumWidth(250);
    widget=new Form(this);
    widget->setGeometry(0,50,width()-ui->dockWidget_2->width()-10,height()-60);
    widget->show();
...
{
    QString qfilename=QFileDialog::getOpenFileName(this,tr("打开变形迷彩文件"),"default.spot","*.spot",0);
}
